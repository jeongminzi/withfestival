...
export default function FrequentAskedQuestions() {
  const faqs = [
    {
      q: "축제랑은 어떤 서비스인가요?",
      a: "축제랑은 대학 축제의 부스 예약, 실시간 웨이팅, 주문 관리부터 방문객들의 텐션을 올리는 부스 랭킹까지 한 번에 제공하는 올인원 스마트 축제 운영 솔루션이에요.",
    },
    {
      q: "총학생회나 축제 기획단만 도입할 수 있나요?",
      a: "그렇지 않아요. 총학생회 차원의 전체 축제는 물론, 개별 학과 주점이나 동아리 부스 단위로도 도입해서 쓸 수 있어요.",
    },
    {
      q: "부스 운영용 기기(포스기, 태블릿)가 따로 필요한가요?",
      a: "별도의 장비 없이도 괜찮아요. 운영진이 갖고 있는 스마트폰이나 태블릿 웹 브라우저만으로 모든 관리자 기능을 쓸 수 있어요.",
    },
    {
      q: "부스 방문객들도 앱을 설치해야 하나요?",
      a: "방문객은 앱 없이 바로 쓸 수 있어요. 부스 입구나 테이블에 놓인 QR 코드를 스마트폰 카메라로 스캔하면 모바일 웹에서 바로 웨이팅 등록과 주문을 할 수 있어요.",
    },
    {
      q: "실시간 부스 랭킹은 어떤 기준으로 정해지나요?",
      a: "각 부스의 포스(POS)나 모바일 주문에서 쌓이는 실시간 누적 매출을 기준으로 자동 집계해서, 일정 시간마다 랭킹 보드에 투명하게 반영해요.",
    },
    {
      q: "서비스 도입 비용은 어떻게 되나요?",
      a: "도입 규모(단일 부스, 학과 연합, 전체 축제 등)와 필요 기능에 맞춰 유연하게 요금제를 맞춰드려요. 위쪽 '도입 문의하기'로 연락해주면 예산에 맞춘 견적을 안내해요.",
    },
    {
      q: "축제 중 시스템에 문제가 생기면 어떻게 하나요?",
      a: "축제 기간에는 긴급 대응 CS팀이 상시 대기해요. 문제가 생기면 바로 원격으로 지원해서 운영이 매끄럽게 이어지도록 도와드려요.",
    },
  ];
        ...
        <div className="mx-auto max-w-3xl">
          <div className="mb-14 flex flex-col items-center text-center md:mb-20">
            ...
            <p className="firsty-lead mt-5 max-w-xl">
              가장 많이 받는 질문을 모아봤어요. 더 궁금한 점이 있으면 도입
              문의로 보내주세요.
            </p>
          </div>
