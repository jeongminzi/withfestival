        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 md:gap-6">
          {FEATURES.map((feature, index) => (
            <motion.div
              ...
              className="firsty-card relative flex min-h-[360px] flex-col overflow-hidden p-7 md:min-h-[420px] md:p-9"
            >
              <span className="firsty-eyebrow self-start">{feature.tag}</span>

              <h3 className="mt-6 text-2xl font-bold leading-tight tracking-tight text-[#11153F] md:text-[28px]">
                {feature.title}
              </h3>
              ...
              <div className="mt-8 flex flex-1 items-end">
                <div
                  className={`relative flex h-44 w-full items-center justify-center overflow-hidden rounded-2xl ${feature.accent} border border-gray-100 md:h-56`}
                >
                  <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,#FFD43A22,transparent_60%)]" />
                  <span className="relative text-sm font-bold uppercase tracking-[0.2em] text-gray-400">
